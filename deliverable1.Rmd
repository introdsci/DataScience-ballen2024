...
p <- ggplot(game_data, aes(x = year, y = mean(game_data$attendance))) + geom_bar(stat="identity", fill="steelblue3") + theme(axis.text.x = element_text(angle=45, hjust=1)) + labs(y="Average Attendance",x="Year") + scale_x_discrete(breaks =  seq(1871, 2016, 5)) + scale_y_continuous(labels = scales::comma)
p
```
